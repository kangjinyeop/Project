...
int CRingBuffer::Get_DirectEnqueueSize()
{
	int TempFront = _FrontPosition;
	int TempRear = _RearPosition;
	int Size = 0;
...
int CRingBuffer::Get_DirectDequeueSize(int Buffer)
{
	int TempFront = _FrontPosition;
...
int CRingBuffer::Get_FrontPosition()
{
	return _FrontPosition;
}

int CRingBuffer::Get_RearPosition()
{
	return _RearPosition;
}

BYTE * CRingBuffer::Get_PreBuffer()
{
	return &_PreBuffer[0];
}

BYTE * CRingBuffer::Get_FrontPointer()
{
	return &_PreBuffer[_FrontPosition];
}

BYTE * CRingBuffer::Get_RearPointer()
{
